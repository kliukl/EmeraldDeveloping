...
"""
    ...
    canopy_structure!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
...
"""
function canopy_structure!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
    ...
    if mask_effective
        ...
        n_eff = 1 / can_str.auxil.ci_diffuse;
    ...
    for i in n_layer:-1:1
        ...
        can_str.auxil.ρ_lw[i] = can_str.auxil.ρ_lw_layer[i] + can_str.auxil.τ_lw_layer[i] ^ 2 * can_str.auxil.ρ_lw[i+1] / denom;    # ir + it-jr-it
    end;
